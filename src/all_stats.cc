...
all_stats_c::all_stats_c(ProcessorStatistics *procStat)
{
    ...
    m_CACHE_WRITE_TOTAL = new COUNT_Stat(
        "CACHE_WRITE_TOTAL", "memory.stat.out", CACHE_WRITE_TOTAL);
    m_CACHE_WRITE_HIT =
        new RATIO_Stat("CACHE_WRITE_HIT", "memory.stat.out",
                       CACHE_WRITE_HIT, CACHE_WRITE_TOTAL, procStat);
    ...
    m_CACHE_READ_TOTAL = new COUNT_Stat(
        "CACHE_READ_TOTAL", "memory.stat.out", CACHE_READ_TOTAL);
    m_CACHE_READ_HIT =
        new RATIO_Stat("CACHE_READ_HIT", "memory.stat.out",
                       CACHE_READ_HIT, CACHE_READ_TOTAL, procStat);
...
all_stats_c::~all_stats_c()
{
    ...
    delete m_L2_WB;
    delete m_L3_WB;
    delete m_CACHE_WRITE_TOTAL;
    delete m_CACHE_WRITE_HIT;
    delete m_TOTAL_DRAM;
    delete m_TOTAL_DRAM_MERGE;
    delete m_CACHE_READ_TOTAL;
    delete m_CACHE_READ_HIT;
    delete m_L1_HIT_CPU;
    delete m_L1_HIT_GPU;
                             ...
                             CoreStatistics *m_coreStatsTemplate)
{
    ...
    m_ProcessorStats->globalStats()->addStatistic(m_CACHE_WRITE_TOTAL);
    m_ProcessorStats->globalStats()->addStatistic(m_CACHE_WRITE_HIT);
    m_ProcessorStats->globalStats()->addStatistic(m_TOTAL_DRAM);
    m_ProcessorStats->globalStats()->addStatistic(m_TOTAL_DRAM_MERGE);
    m_ProcessorStats->globalStats()->addStatistic(m_CACHE_READ_TOTAL);
    m_ProcessorStats->globalStats()->addStatistic(m_CACHE_READ_HIT);
